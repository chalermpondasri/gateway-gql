import { GetObjectAclCommandInput, GetObjectCommand, PutObjectCommand, PutObjectCommandInput, S3 } from "@aws-sdk/client-s3";
...
export class ByteArkRepository implements IByteArkRepository {
    ...
    private _generateSignedUrlForGet(params: GetObjectAclCommandInput){
        return from(getSignedUrl(this._s3, new GetObjectCommand(params), {expiresIn: 60,}))
    }

    public uploadFile(imgName: string, file: Buffer){    
